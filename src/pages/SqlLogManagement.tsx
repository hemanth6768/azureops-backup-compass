      ...
      <div className="min-h-screen flex w-full bg-background">
        ...
        <SidebarInset className="flex-1">
          ...
          <main className="flex-1 space-y-4 p-4 md:p-6 lg:p-8">
            <div className="mb-6">
              <h1 className="text-3xl font-bold text-foreground">Log Management Files</h1>
              <p className="text-muted-foreground mt-2">Search databases and switch between row/log file types</p>
            </div>
