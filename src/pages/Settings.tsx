...
const Settings = () => {
  ...
  const applyTheme = (themeId: string) => {
    ...
    if (theme) {
      ...
      root.style.setProperty(
        "--sidebar-accent",
        theme.colors.mode === "dark" ? "220 13% 18%" : "220 13% 95%"
      );
      root.style.setProperty(
      ...
      root.style.setProperty(
        "--sidebar-hover",
        theme.colors.mode === "dark" ? "220 13% 15%" : "220 13% 92%"
      );
      ...
      root.style.setProperty(
        "--gradient-primary",
        `linear-gradient(135deg, hsl(${theme.colors.primary} / 0.9), hsl(${theme.colors.primaryGlow} / 0.8))`
      );
      root.style.setProperty(
        "--gradient-sidebar",
        `linear-gradient(180deg, hsl(${theme.colors.sidebar} / 0.95), hsl(${theme.colors.sidebar} / 0.9))`
      );
    }
  };
